...
def compute_bias_metrics() -> dict:
    ...
    with Session(engine) as session:
        ...
        # We find decisions that got appealed
        ...
        # Decisions where gap was primary (e.g. recent delinquencies mapped to gap)
        # Identify how many "Recent Delinquencies" or related primary_factors there are
        ...
        # Check for alert: if any factor shows > 15% disparity between raw denial rate and appeal success rate.
        # This is complex, so let's simplify to a mock alert if the gap percent > 15%
        alerts = []
